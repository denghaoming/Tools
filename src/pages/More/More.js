    ...
    render() {
        return (
            <div className="Token">
                ...
                <div className="button ModuleTop" onClick={this.routerTo.bind(this,'/checkCreateContract')}>创建能够部署token1的钱包</div>

                <div className="button ModuleTop" onClick={this.routerTo.bind(this,'/ck')}>批量撸CK</div>
